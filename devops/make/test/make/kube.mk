...
test-common-kube:
	...
	@APP=$(APP) KUBE_NAMESPACE=$(KUBE_NAMESPACE) KUBE_CONTEXT=$(KUBE_CONTEXT) bash sh/update-kube-object.sh ./test/fixtures/secrets 		> /dev/null
	@APP=$(APP) KUBE_NAMESPACE=$(KUBE_NAMESPACE) KUBE_CONTEXT=$(KUBE_CONTEXT) bash sh/update-kube-object.sh ./test/fixtures/configmaps 	> /dev/null
