...
SHELLCHECK_BIN := $(shell which shellcheck 2> /dev/null)
...
_install_shellcheck:
	...
	@curl -s -L https://storage.googleapis.com/shellcheck/shellcheck-v${SHELLCHECK_VERSION}.linux.x86_64.tar.xz | tar --strip-components=1 -xJvf - shellcheck-v${SHELLCHECK_VERSION}/shellcheck
	@mkdir -p $$HOME/bin
