...
deploy: update-configmaps update-services migrate update-deployment check-deployment-status
...
check-deployment-status: ## validate that deployment to kube was successful
	@timeout 600 $(KUBECTL_CMD) rollout status deployment/$(APP) \
